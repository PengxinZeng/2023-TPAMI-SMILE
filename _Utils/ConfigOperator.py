...
def main():
    ...
    vc = '/xlearning/pengxin/Codes/Recap0709/Run0715_Reproduce_NCR_PretrainFromWarmup/ --PureSGR --pretrain_model_path -noise_ratio 0@output@model_best.pth.tar/output/model_best.pth.tar'.split('/')
    print(vc)
    print(vc[-3:])
